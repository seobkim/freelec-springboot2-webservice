...
public class PostsRepositoryTest {
    ...
    // 여러 테스트가 동시에 수행되면 테스트용 데이터베이스인 H2에 데이터가 그대로 남아 있어 다음 테스트 실행시 테스트 실패할 수 있음.
    @After
    public void cleanup(){
    ...
    public void 게시글저장_불러오기(){
        ...
        // 테이블에 posts에 insert/update 쿼리를 실행함
    ...
    public void BaseTimeEntity_등록(){
        ...
        System.out.println(posts.getCreatedDate().isAfter(now));
